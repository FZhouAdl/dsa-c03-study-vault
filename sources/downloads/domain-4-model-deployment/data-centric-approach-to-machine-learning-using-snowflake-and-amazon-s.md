---
title: "Data-centric Approach to Machine Learning Using Snowflake and Amazon SageMaker Data Wrangler"
source: https://quickstarts.snowflake.com/guide/vhol_snowflake_data_wrangler/index.html
...
[Snowflake for Developers](https://www.snowflake.com/content/snowflake-site/global/en/developers)/[Guides](https://www.snowflake.com/content/snowflake-site/global/en/developers/guides)/Data-centric Approach to Machine Learning Using Snowflake and Amazon SageMaker Data Wrangler

Quickstart

## Data-centric Approach to Machine Learning Using Snowflake and Amazon SageMaker Data Wrangler

andries.engelbrecht@snowflake.com

[Fork Repo](https://github.com/Snowflake-Labs/sfquickstarts/tree/master/site/sfguides/src/vhol-snowflake-data-wrangler)
...
The first thing you will need to do is download the following .sql file that contains a series of SQL commands we will execute throughout this lab. **Click the green button to download the file** [Data_Wrangler_Snowflake_VHOL_V2.sql](https://snowflake-corp-se-workshop.s3.us-west-1.amazonaws.com/VHOL_Snowflake_Data_Wrangler/V2/files/Data_Wrangler_Snowflake_VHOL_V2.sql)
...
[Github Repo](https://github.com/dylan-tong-aws/snowflake-sagemaker-workshops)
...
The Snowflake Storage Integration name from Step 4 will be used - **SMSNOW_ __STORAGE_INTEGRATION**
...
First we will fix the **INT_RATE** column from a string with a % sign to a numeric data type.
  ...
  * In the **Replacement string** _type space and then delete it_ to have % replaced with an empty string
  * Click Preview
  * Click Add
...
Related Resources
  ...
  * [Download Reference Architecture](/content/dam/snowflake-site/developers/2024/04/Student-Loan-Default-Prediction-using-Snowpark-ML-and-Amazon-SageMaker.pdf)
