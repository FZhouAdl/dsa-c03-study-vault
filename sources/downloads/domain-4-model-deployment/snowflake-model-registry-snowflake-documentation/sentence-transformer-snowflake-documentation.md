---
title: "Sentence Transformer | Snowflake Documentation"
source: https://docs.snowflake.com/developer-guide/snowflake-ml/model-registry/built-in-models/sentence-transformer
...
The Snowflake Model Registry supports models that use Sentence Transformers (`sentence_transformers.SentenceTransformer`). For more information, see the [Sentence Transformers documentation](https://sbert.net/).
...
In the example, `reg` is an instance of `snowflake.ml.registry.Registry`. For information on creating a registry object, see [Snowflake Model Registry](/developer-guide/snowflake-ml/model-registry/overview).
[code] 
