---
title: "Snowflake Container Runtime | Snowflake Documentation"
source: https://docs.snowflake.com/developer-guide/snowflake-ml/container-runtime-ml
...
The :class:`snowflake.ml.data.data_connector.DataConnector` class connects Snowpark DataFrames or Snowflake ML Datasets to TensorFlow or PyTorch DataSets or Pandas DataFrames. Instantiate a connector using one of the following class methods:
