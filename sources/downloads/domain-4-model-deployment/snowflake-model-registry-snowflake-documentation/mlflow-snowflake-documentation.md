---
title: "MLFlow | Snowflake Documentation"
source: https://docs.snowflake.com/developer-guide/snowflake-ml/model-registry/built-in-models/mlflow
...
You can use MLflow models that support PyFunc. If your MLFlow model has a signature, the `signature` argument is inferred from the model. Otherwise, you must provide either `signature` or `sample_input_data`.
