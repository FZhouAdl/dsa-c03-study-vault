---
title: "Understanding Snowflake Table Structures | Snowflake Documentation"
source: https://docs.snowflake.com/user-guide/tables-micro-partitions
...
These topics describe _micro-partitions_ and _data clustering_ , two of the principal concepts utilized in Snowflake physical table structures. They also provide guidance for explicitly defining _clustering keys_ for very large tables (in the multi-terabyte range) to help optimize table maintenance and query performance.
