...
source: https://docs.snowflake.com/guides-overview-queries
...
A join on a key column can refer to tables that are not needed for the join. Such a join is referred to as a _redundant join_.
