---
title: "SHA2 , SHA2_HEX | Snowflake Documentation"
source: https://docs.snowflake.com/sql-reference/functions/sha2
...
If you need to encrypt and decrypt data, use the following functions:
    ...
    * [ENCRYPT_RAW](/sql-reference/functions/encrypt_raw) and [DECRYPT_RAW](/sql-reference/functions/decrypt_raw)
