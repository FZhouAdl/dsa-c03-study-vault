...
source: https://docs.snowflake.com/sql-reference/sql/begin
...
## Usage notes¶
  ...
  * All transactions have a system-generated internal ID. The transaction ID is a signed 64-bit (long) integer. The range of values is -9,223,372,036,854,775,808 (-2 63) to 9,223,372,036,854,775,807 (2 63 \- 1).
  ...
  * If two BEGIN statements in a row are executed (within the same [scope](/sql-reference/transactions#label-scoped-transactions)), the second one is ignored. For example, in the following code, the second and third BEGINs have no effect; the existing open transaction continues.
[code] BEGIN;
        BEGIN;    -- Ignored!
        INSERT INTO table1 ...;
        BEGIN;    -- Ignored!
