---
title: "Function and stored procedure reference | Snowflake Documentation"
source: https://docs.snowflake.com/en/sql-reference-functions.html
...
These topics provide reference information for the system-defined functions and system-defined stored procedures.
  ...
  * [Model monitor functions](/sql-reference/functions-model-monitors) — functions that retrieve metrics from machine learning model monitors.
