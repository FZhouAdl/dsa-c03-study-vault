---
title: "JDBC Driver | Snowflake Documentation"
source: https://docs.snowflake.com/developer-guide/jdbc/jdbc
...
The driver can be used with most client tools/applications that support JDBC for connecting to a database server. [sfsql](/user-guide/sfsql), the now-deprecated command-line client provided by Snowflake, is an example of a JDBC-based application.
