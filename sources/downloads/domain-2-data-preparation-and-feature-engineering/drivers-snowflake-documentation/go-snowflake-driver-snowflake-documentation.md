---
title: "Go Snowflake Driver | Snowflake Documentation"
source: https://docs.snowflake.com/developer-guide/golang/go-driver
...
The Go Snowflake Driver provides an interface for developing applications using the Go programming language to connect to Snowflake and perform all standard operations. The driver implements the Go [database/sql](https://golang.org/pkg/database/sql) package.
