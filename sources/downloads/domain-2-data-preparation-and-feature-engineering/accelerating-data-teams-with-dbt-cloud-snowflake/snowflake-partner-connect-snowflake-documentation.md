...
source: https://docs.snowflake.com/en/user-guide/ecosystem-partner-connect.html
...
Partner Connect is being migrated to the Snowflake Marketplace. Partner trial accounts that were previously available through Partner Connect are now available to start from the provider’s Marketplace listings. This allows you to start a free trial of a partner’s application directly from a Marketplace listing. For details, see [Trial SaaS applications from listings](/collaboration/consumer-saas-trials).
...
---|---|---  
[](https://www.altr.com/)[](/static/images/logo-altr.svg)| [Security, Governance & Observability](/user-guide/ecosystem-security)| Free forever plan  
[](https://carto.com/)[](/static/images/logo-carto.svg)| [Business Intelligence (BI)](/user-guide/ecosystem-bi)|   
[](https://coalesce.io/)[](/static/images/logo-coalesce.png)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://www.dataiku.com/dss/editions/)[](/static/images/logo-dataiku.svg)| [Machine Learning & Data Science](/user-guide/ecosystem-analytics)|   
[](https://www.getdbt.com/)[](/static/images/logo-dbtlabs.png)| [Data Integration](/user-guide/ecosystem-etl)| dbt Cloud  
[](https://www.domo.com/)[](/static/images/logo-domo.svg)| [Business Intelligence (BI)](/user-guide/ecosystem-bi)|   
[](https://etleap.com/)[](/static/images/logo-etleap.svg)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://www.fivetran.com)[](/static/images/logo-fivetran.svg)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://hevodata.com/)[](/static/images/logo-hevo.png)| [Data Integration](/user-guide/ecosystem-etl)| Hevo Data CDC for ETL  
[](https://hex.tech/)[](/static/images/logo-hex.png)| [Machine Learning & Data Science](/user-guide/ecosystem-analytics)|   
[](https://hightouch.com/)[](/static/images/logo-hightouch.png)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://hunters.ai/)[](/static/images/logo-hunters.svg)| [Security, Governance & Observability](/user-guide/ecosystem-security)|   
[](https://www.informatica.com)[](/static/images/logo-informatica.svg)| [Data Integration](/user-guide/ecosystem-etl)| Informatica Cloud  
[](https://marketplace.informatica.com/forms/data-loader.html)[](/static/images/logo-informatica.svg)| [Data Integration](/user-guide/ecosystem-etl)| Informatica Data Loader  
[](http://www.keboola.com/)[](/static/images/logo-keboola.png)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://www.matillion.com/products/data-loader/)[](/static/images/logo-matillion.png)| [Data Integration](/user-guide/ecosystem-etl)| Matillion Data Productivity Cloud  
[](https://sigmacomputing.com/)[](/static/images/logo-sigma.png)| [Business Intelligence (BI)](/user-guide/ecosystem-bi)|   
[](https://www.snaplogic.com/)[](/static/images/logo-snaplogic.svg)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://sqldbm.com/Home/)[](/static/images/logo-sqldbm.svg)| [SQL Development & Management](/user-guide/ecosystem-editors)|   
[](https://www.striim.com/)[](/static/images/logo-striim.svg)| [Data Integration](/user-guide/ecosystem-etl)|   
[](https://www.thoughtspot.com/)[](/static/images/logo-thoughtspot.svg)| [Business Intelligence (BI)](/user-guide/ecosystem-bi)|   
...
To use shared databases with a trial:
     ...
     * Use [Snowsight](/user-guide/ui-snowsight-gs#label-snowsight-getting-started-sign-in) to complete the initial connection process.
...
This role is then granted to the PC_<_partner_ >_ROLE, which enables all the tables in the specified databases to be used by the partner application with minimal (or no) additional configuration.
...
Partner applications may include automated features such as dashboards that run on a schedule and consume compute resources. We encourage you to read the product documentation for a partner application and to [monitor usage](/user-guide/warehouses-load-monitoring) of the PC_<_partner_ >_WH warehouse to avoid unexpected Snowflake credit usage by the application.

## Adding Partner IP Addresses to Network Policies¶

If you use a [network policy](/user-guide/network-policies) to restrict access to your Snowflake account based on user IP address, partner applications will not be able to access your account unless you add the partner’s IP addresses to the list of allowed IP addresses in the network policy. For detailed instructions, see [Modify a network policy](/user-guide/network-policies#label-modifying-network-policies).
...
During the initial connection process, if you specified existing databases to use with the partner application, remember to also drop the PC_<_partner_ >_DB_PICKER_ROLE role that was automatically created along with the other objects.

  6. Open a new worksheet in [Snowsight](/user-guide/ui-snowsight-gs#label-snowsight-getting-started-sign-in) and run the following command to complete the removal of the partner connection:
[code] select system$remove_etl_integration('partnername');
