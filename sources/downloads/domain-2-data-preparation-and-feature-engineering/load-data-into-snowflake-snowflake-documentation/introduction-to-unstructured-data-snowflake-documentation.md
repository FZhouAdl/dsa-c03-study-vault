...
source: https://docs.snowflake.com/user-guide/unstructured-intro
...
The URL expires when the [persisted query result period](/user-guide/querying-persisted-results) ends (i.e. the results cache expires), which is currently 24 hours.
...
Usage| The following options are available:
  ...
  * Send a scoped URL in a GET request to the file support REST API endpoint. For information, see [REST API for unstructured data support](/user-guide/data-load-unstructured-rest-api).
...
| The following options are available:
  ...
  * Send a file URL in a GET request to the file support REST API endpoint. For information, see [REST API for unstructured data support](/user-guide/data-load-unstructured-rest-api).
...
To configure server-side encryption for an internal stage, specify the `SNOWFLAKE_SSE` encryption type in the [CREATE STAGE](/sql-reference/sql/create-stage) command. See [Internal stage parameters (`internalStageParams`)](/sql-reference/sql/create-stage#label-create-stage-internalstageparams) for more information.
...
[TO_FILE](/sql-reference/functions/to_file)| Returns a FILE object that represents a file stored in an internal or external stage.  
[TRY_TO_FILE](/sql-reference/functions/try_to_file)| Returns a FILE object as with TO_FILE, but returns NULL if the file does not exist or is not accessible.  
  
## Download staged files in Snowsight¶

### Download a generated scoped, pre-signed, or file URL¶

Users can select a generated scoped, pre-signed, or file URL in the results table of a [Snowsight](/user-guide/ui-snowsight-gs#label-snowsight-getting-started-sign-in) worksheet and download the referenced file.

  1. Sign in to [Snowsight](/user-guide/ui-snowsight-gs#label-snowsight-getting-started-sign-in).
  2. In the navigation menu, select **Projects** » **Worksheets** » **My Worksheets** , or open a local worksheet by navigating to **Recent** or **Folders** » _< worksheet_name>_.
...
Users can download a file from the internal stage directly from Snowsight.
  ...
  3. Select the [](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png) button, and select **Download**.
...
The [FILE data type](/sql-reference/data-types-unstructured#label-data-types-file) represents a file stored in an internal or external stage. Some built-in functions accept a FILE object in place of a stage name and file path. Use the [TO_FILE](/sql-reference/functions/to_file) or [TRY_TO_FILE](/sql-reference/functions/try_to_file) function to convert a file’s location in a stage to a FILE object.
