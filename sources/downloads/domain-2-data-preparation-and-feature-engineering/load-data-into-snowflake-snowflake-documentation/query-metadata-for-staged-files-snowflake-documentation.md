---
title: "Query metadata for staged files | Snowflake Documentation"
source: https://docs.snowflake.com/user-guide/querying-metadata
...
The [COPY INTO <table>](/sql-reference/sql/copy-into-table) command supports copying metadata from staged data files into a target table. Use the data transformation syntax (i.e. a SELECT list) in your COPY statement. For more information about transforming data using a COPY statement, see [Transform data during a load](/user-guide/data-load-transform).
