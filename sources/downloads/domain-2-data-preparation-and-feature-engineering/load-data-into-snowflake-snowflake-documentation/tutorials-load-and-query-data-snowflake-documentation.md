---
title: "Tutorials: Load and query data | Snowflake Documentation"
source: https://docs.snowflake.com/user-guide/data-load-tutorials
...
These tutorials show you how to load data into a table by using the [COPY INTO <table>](/sql-reference/sql/copy-into-table) command. For information about other options for loading data, see [Overview of data loading](/user-guide/data-load-overview).
