---
title: "Summary of data loading features | Snowflake Documentation"
source: https://docs.snowflake.com/user-guide/intro-summary-loading
...
This topic provides a quick-reference of the supported features for using the [COPY INTO <table>](/sql-reference/sql/copy-into-table) command to load data from files into Snowflake tables.
...
| [Semi-structured formats](/user-guide/semistructured-intro)
...
File encoding| File format-specific| For delimited files (CSV, TSV, etc.), the default character set is UTF-8. To use any other character sets, you must explicitly specify the encoding to use for loading. For the list of supported character sets, see Supported Character Sets for Delimited Files (in this topic).  
