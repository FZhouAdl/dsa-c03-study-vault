...
source: https://docs.snowflake.com/sql-reference/functions/hll_combine
...
This allows scenarios where [HLL_ACCUMULATE](/sql-reference/functions/hll_accumulate) is run over horizontal partitions of the same table, producing an algorithm state for each table partition. These states can later be combined using [HLL_COMBINE](/sql-reference/functions/hll_combine), producing the same output state as a single run of [HLL_ACCUMULATE](/sql-reference/functions/hll_accumulate) over the entire table.

See also:
    

[HLL](/sql-reference/functions/hll) , [HLL_ACCUMULATE](/sql-reference/functions/hll_accumulate) , [HLL_ESTIMATE](/sql-reference/functions/hll_estimate)
...
An expression that contains state information generated by a call to [HLL_ACCUMULATE](/sql-reference/functions/hll_accumulate).
